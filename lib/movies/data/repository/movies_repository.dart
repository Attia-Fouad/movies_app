...
class MoviesRepository extends BaseMoviesRepository {
  ...
  @override
  Future<Either<Failure, MovieDetail>> getMoviesDetails(MovieDetailParameters parameters) async {
    final result = await moviesBaseRemoteDateSource.getMovieDetails(parameters);
    try {
      return Right(result);
    } on ServerException catch (failure) {
      return Left(ServerFailure(failure.errorMessageModel.statusMessage));
  ...
  Future<Either<Failure, List<Recommendation>>> getRecommendation(RecommendationParameters parameters) async {
    final result = await moviesBaseRemoteDateSource.getRecommendation(parameters);
    try {
      return Right(result);
    } on ServerException catch (failure) {
      return Left(ServerFailure(failure.errorMessageModel.statusMessage));
